...
> **⚠️ 2026-07-14 보류 결정**: 0.3.0 배포·데이터 계약 정렬과 0.2.8 구독 빌링 수정 이후
> 전환 실익 대비 손실이 커져 **현재 시점 전환 보류**. 재평가 상세: `devlog/20260714_015_p06_django_migration_reevaluation.md`.
> 이 문서는 "웹앱으로 성장 시" 참고용으로 보존.
